...
export default ({
  subheading = "Want to know more about the app ?",
  heading = "Visit the documentation/timing analysis pages !",
  primaryLinkText = "Documentation",
  primaryLinkUrl = "doc",
  secondaryLinkText = "Timing Analysis",
  secondaryLinkUrl = "timing",
  pushDownFooter = true
}) => {
  return (
